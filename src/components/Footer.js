                ...
                <div className='col-4'>
                    ...
                    <div>
                        <address className='text-white fs-6'>
                            Hno : 277 Near VIT Vellore,
                            <br/>Katpadi, Tamil Nadu <br/>
                            Pincode:632004
                        </address>
                        <a href="tel:+91 8264954234" className='mt-3 d-block mb-1 text-white'>
                            +91 8264954234
                        </a>
                        <a href="mailto:AbrarSwapit@gmail.com" className='mt-2 d-block mb-0 text-white'>
                            AbrarSwapit@gmail.com
                        </a>
        ...
        <div className='container-xxl'>
            <div className='row'>
                <div className='col-12'>
                    <p className='text-center mb-0 text-white'>&copy; { new Date().getFullYear()}; Powered by SwapIt</p>
                </div>
            </div>
        </div>
    </footer>
