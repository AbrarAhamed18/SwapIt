...
<div>
    <input className="form-control" type="number" name="" min={1} max={10} id="" value={productUpdateDetail?.quantity?productUpdateDetail?.quantity:item?.quantity}
...
<div className="col-12 py-2 mt-4">
    ...
    <Link to='/product' className="button">Continue To Browse</Link>
    {
