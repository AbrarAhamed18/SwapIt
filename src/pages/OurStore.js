      ...
      <Container class1="store-wrapper home-wrapper-2 py-5">
            ...
            <div className="row">
                <div className="col-3">
                    ...
                    <div className='filter-card mb-3'>
                        ...
                        <div>
                            ...
                            <div className="form-check">
                            <input className="form-check-input" type="checkbox" value="" id="" defaultChecked={true}/>
                ...
                <select name="" className="form-control form-select" id="">
                    ...
                    {/* <div className="d-flex align-items-center gap-10"> <p className="totalproducts">21 Products</p>
